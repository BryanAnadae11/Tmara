# Generated by Django 6.0.6 on 2026-08-15 23:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Tmaraprojapp.client')),
            ],
        ),
        migrations.CreateModel(
            name='History',
            fields=[
                ...
                ('amount', models.FloatField(blank=True, null=True)),
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Tmaraprojapp.client')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_address_answer', models.CharField(blank=True, max_length=255, null=True)),
                ('next_of_kin', models.CharField(blank=True, max_length=255, null=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('client', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='security_questions', to='Tmaraprojapp.client')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
